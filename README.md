...
- **Pin Wing Clip to a lower rank:** Config has a **Wing Clip rank** slider — leave it at *highest known*, or pin it to Rank 1 for the kiting snare: the same 10-second slow for less mana and far less damage, so it barely adds threat and won't finish off a mob you meant to keep kited. The button's tooltip shows the rank you pinned (and its numbers). Because action buttons are combat-protected, changing the rank mid-fight is queued and takes effect the moment you leave combat.
